...
// Motion is handled entirely in CSS (see styles.css) — no external library,
// nothing that can fail on a slow connection. Elements are always visible
// even if a browser somehow ignores the CSS animation.
